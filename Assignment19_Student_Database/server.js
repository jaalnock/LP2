...
// Replace with your MongoDB Atlas URI (use 'student' as DB name)
...
app.get('/insert', async (req, res) => {
  await Student.insertMany([
    ...
    { Name: "XYZ", Roll_No: 112, WAD_Marks: 28, CC_Marks: 22, DSBDA_Marks: 30, CNS_Marks: 24, AI_Marks: 26 },
    { Name: "PQR", Roll_No: 113, WAD_Marks: 19, CC_Marks: 21, DSBDA_Marks: 18, CNS_Marks: 23, AI_Marks: 20 },
    { Name: "LMN", Roll_No: 114, WAD_Marks: 35, CC_Marks: 29, DSBDA_Marks: 32, CNS_Marks: 30, AI_Marks: 33 },
    { Name: "DEF", Roll_No: 115, WAD_Marks: 15, CC_Marks: 16, DSBDA_Marks: 12, CNS_Marks: 14, AI_Marks: 18 }
  ]);
